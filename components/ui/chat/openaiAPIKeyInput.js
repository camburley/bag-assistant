...
export function OpenAIAPIKeyInput({ oaiKey, setOaiKey }) {
  ...
  useEffect(() => {
    ...
    setOaiKey(process.env.NEXT_PUBLIC_OPENAI_API_KEY) // Set the oaiKey state to the env variable
    setIsKeyValid(true)
  }, [inputOaiKey])
  ...
  return (
    <div className="mb-[-50px] mt-[25px]" style={{ display: 'none' }}>
